...
const PROJECTS: Project[] = [
    {
        ...
        category: 'WEB DESIGN',
        state: 'Completed',
        shortDesc: 'If several languages coalesce the grammar is more simple and regular than that of the individual languages...',
        totalQuestions: 56,
        totalComments: 452,
        teamMembers: [
            {
    ...
    },
    {
        ...
        category: 'WEB DESIGN',
        state: 'Completed',
        shortDesc: 'It will be as simple as occidental in fact it will be to an english person it will seem like simplified English...',
        totalQuestions: 87,
        totalComments: 125,
        teamMembers: [
            {
    ...
    },
    {
        ...
        category: 'ANDROID',
        state: 'Completed',
        shortDesc: 'Everyone realizes why a new common language would be desirable one could refuse to pay expensive translators...',
        totalQuestions: 77,
        totalComments: 875,
        teamMembers: [
            {
    ...
    },
    {
        ...
        category: 'WEB DESIGN',
        state: 'Completed',
        shortDesc: 'Their separate existence is a myth. For science, music, sport, etc, Europe uses the same vocabulary....',
        totalQuestions: 56,
        totalComments: 452,
        teamMembers: [
            {
