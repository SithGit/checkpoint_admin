...
@NgModule({
    declarations: [MemberListComponent, ProfileComponent, UserBoxComponent, PostBoxComponent, CommentBoxComponent],
    imports: [CommonModule, ReactiveFormsModule, NgbModalModule, WidgetModule, ContactsRoutingModule],
})
