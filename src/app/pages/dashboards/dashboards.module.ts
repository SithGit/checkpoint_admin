...
@NgModule({
    declarations: [DashboardOneComponent, SalesChartComponent, StatisticsChartComponent, RevenueChartComponent, InboxComponent, ProjectsComponent],
    imports: [CommonModule, NgApexchartsModule, NgbDropdownModule, WidgetModule, DashboardsRoutingModule],
})
