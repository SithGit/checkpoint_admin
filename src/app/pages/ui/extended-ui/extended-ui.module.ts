...
@NgModule({
    declarations: [RangeslidersComponent, SweetAlertsComponent, DraggableCardsComponent, TourPageComponent, TreeViewComponent],
    imports: [CommonModule, NgxSliderModule, SortablejsModule, SweetAlert2Module, TreeModule, JoyrideModule, NgbDropdownModule, ExtendedUiRoutingModule],
})
