...
export class ApexComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.eventService.broadcast(EventType.CHANGE_PAGE_TITLE, {
            ...
            breadCrumbItems: [
                { label: 'Charts', path: '.' },
                { label: 'Apexchart', path: '.', active: true },
            ],
        });
        this.initLineChart();
        this.initBarChart();
            ...
            series: [
                {
                    name: 'Prices',
                    data: [
                        8107.85, 8128, 8122.9, 8165.5, 8340.7, 8423.7, 8423.5, 8514.3, 8481.85, 8487.7, 8506.9, 8626.2, 8668.95, 8602.3, 8607.55, 8512.9, 8496.25, 8600.65, 8881.1,
                        9340.85,
                    ],
                },
            ],
